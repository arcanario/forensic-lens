  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    try {
      ...
      const parsed = isJpeg ? fullJpegParse(buffer) : {
        markers: [], markerSequence: '', totalMarkers: 0,
        quantizationTables: [], estimatedQuality: null, qualityMethod: '',
        sofInfo: null, huffmanTables: [], sosInfo: null, jfifInfo: null,
        adobeInfo: null, driInfo: null, comments: [], subsamplingLabel: 'N/A',
        hasThumbnail: false, thumbnailSource: '', hasTrailingData: false,
        trailingDataSize: 0, signatures: [],
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-foreground tracking-tight">
                ...
                <span className="text-xs text-muted-foreground ml-2 font-mono">/ JPEG</span>
              </h1>
              <p className="text-[10px] text-muted-foreground font-mono tracking-widest uppercase">
                Análise Forense JPEG
              </p>
            </div>
          </div>
          ...
          {!result ? (
            ...
            >
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-foreground mb-2">Análise JPEG / PNG</h2>
                <p className="text-sm text-muted-foreground max-w-md mx-auto">
                  Faça upload de uma imagem JPEG ou PNG para análise completa de integridade, marcadores e compressão.
                </p>
              </div>
              <FileUpload onFileSelect={handleFileSelect} isAnalyzing={isAnalyzing} acceptTypes="image" />
            </motion.div>
          ) : (
            <motion.div
              key="results"
